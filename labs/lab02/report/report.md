...
Далее создадим ключ **ssh** по алгоритму rsa с ключом размером 4096 бит с помощью команды `ssh-keygen -t rsa -b 4096` (рис. [-@fig:003]).
...
![Учетная запись GitHub](image/5.png ){#fig:005 width=70%}
